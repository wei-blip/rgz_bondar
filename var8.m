...
f = 0.001:0.001:10;
ft1 = 1;
G_f = BpskQpskSpectrum(f,ft);    %Энергетический спектр сигнала
P_F = cumtrapz(f,G_f);
...
% по предыдущим расчетам определена Fв(при гамма в квадрате, равной
% 0.99)=5.345
F_high = 5.345;
Fe = 3.0896;
...
v=7.745; %значение нормированной частоты п.2
Fv = v*ft;
f = 0.001:0.001:Fv;
G_f = BpskQpskSpectrum(f,ft);
